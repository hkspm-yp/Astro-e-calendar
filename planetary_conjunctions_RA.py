        ...
        if i < j:
            ...
            for t, planetary_conjunctions_degrees in zip(planetary_conjunctions_times, planetary_conjunctions):
                if planetary_conjunctions_degrees < 0.1:
                    ...
                    temp_list_planetary_conjunctions[1]=planet_name_list_eng[i] + ' '+ planet_name_list_eng[j]+ ' conjunction (right ascension)'
                    temp_list_planetary_conjunctions[0]=planet_name_list_chi[i] + '合'+ planet_name_list_chi[j]+  '（赤經）'
