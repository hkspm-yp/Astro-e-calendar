        ...
        if i < j:
            ...
            for t, planetary_appulse_degrees in zip(planetary_appulse_times, planetary_appulse):
                if planetary_appulse_degrees <5:
                    ...
                    # temp_list_planetary_appulse[4]='角距 Angular separation: ' + str("%0.2f" % planetary_appulse_degrees) +'°; ' + 'Phase angle of '+ planet_name_list_eng[i] +' is ' + str(int(earth.at(t).observe(planet_list_top[i]).phase_angle(sun).degrees))+'°'
