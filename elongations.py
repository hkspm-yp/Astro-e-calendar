...
for t, Venus_elongation_degrees in zip(Venus_times, Venus_elongations):
    ...
    temp_list_elongations=['0=year', '1=month','2=date','3=hour','4=minute','5=second','6=event_Eng','7=event_Chi']
    temp_list_elongations[0]=t.astimezone(HKT).year
    temp_list_elongations[1]=t.astimezone(HKT).month
    temp_list_elongations[2]=t.astimezone(HKT).day
    temp_list_elongations[3]=t.astimezone(HKT).hour
    temp_list_elongations[4]=t.astimezone(HKT).minute
    temp_list_elongations[5]=int(t.astimezone(HKT).second)
    temp_list_elongations[6]=Venus_direction + ' (' + str(int(Venus_elongation_degrees)) +'°)'
    temp_list_elongations[7]=Venus_direction_chi + ' (' + str(int(Venus_elongation_degrees)) +'°)'
...
for t, Mercury_elongation_degrees in zip(Mercury_times, Mercury_elongations):
    ...
    temp_list_elongations[4]=t.astimezone(HKT).minute
    temp_list_elongations[5]=int(t.astimezone(HKT).second)
    temp_list_elongations[6]=Mercury_direction + ' (' + str(int(Mercury_elongation_degrees)) +'°)'
    temp_list_elongations[7]=Mercury_direction_chi + ' (' + str(int(Mercury_elongation_degrees)) +'°)'
    list_elongations.append(temp_list_elongations)
