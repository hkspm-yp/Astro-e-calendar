...
for t, earth_aphelion_distance in zip(earth_aphelion_times, earth_aphelion_s):
    ...
    temp_list_earth_aphelion[4]=''
    temp_list_earth_aphelion[1]='Earth at aphelion (' + str(int(earth_aphelion_distance)) + 'km)'
    temp_list_earth_aphelion[0]='地球過遠日點 (' + str(int(earth_aphelion_distance)) + '公里)'
...
for t, earth_perihelion_distance in zip(earth_perihelion_times, earth_perihelion_s):
    ...
    temp_list_earth_perihelion[4]=''
    temp_list_earth_perihelion[1]='Earth at perihelion (' + str(int(earth_perihelion_distance)) + 'km)'
    temp_list_earth_perihelion[0]='地球過近日點 (' + str(int(earth_perihelion_distance)) + '公里)'
